...
func Admin(params ...string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<!doctype html><html><head><title>Shop</title><meta charset=\"UTF-8\"><meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0\"><link rel=\"preconnect\" href=\"https://fonts.googleapis.com\"><link rel=\"preconnect\" href=\"https://fonts.gstatic.com\" crossorigin><link href=\"https://fonts.googleapis.com/css2?family=Inter:ital,opsz,wght@0,14..32,100..900;1,14..32,100..900&amp;family=Montserrat:ital,wght@0,100..900;1,100..900&amp;display=swap\" rel=\"stylesheet\"><style>\n            :root{\n                    --primary: #656565;\n                    --text-heading: #5F5F5F;\n                    --text: #656565;\n                    --text-surface-heading: #FFF;\n                    --text-surface: #DDD;\n                    --background: #FFF;\n\n                    --padding: 15px;\n                    --padding-inner: 50px;\n                }\n                * {\n                    font-family: \"Montserrat\", sans-serif;\n                    font-size: 0.9rem;\n                    font-style: normal;\n                    line-height: 2.7rem;\n\n                    outline: none;\n                }\n                html, body, .overflow {\n                    margin: 0;\n                    width: 100%;\n                    height: 100% !important;\n\n                    display: flex;\n                    flex-direction: column;\n                    align-items: strech-content;\n\n                    background-color: var(--background);\n                    color: var(--text);\n\n                    overflow-x: hidden;\n                }            \n                h1, h2, h3, h4 {\n                    /* font-size: 1.5rem; */\n                    font-weight: 400;\n                    color: var(--text-heading);\n                }\n                h1 {\n                    font-size: 1.5rem;\n                } h4 {\n                    font-size: 1.1rem;\n                }\n\n                .surface h1, .surface h2, .surface h3 {\n                    color: var(--text-surface-heading);\n                }\n                .surface, .button-primary {\n                    background-color: var(--primary);\n                    color: var(--text-surface);\n                    border: none;\n                }\n                .button-secondary{\n                    background-color: var(--text-surface-heading);\n                    color: var(--text);\n                    border: 1px solid var(--primary);\n                }\n                .button-primary, .button-secondary{\n                    padding: 5px;\n                    padding-inline: 25px;\n                    font-size: 1.05rem;\n                }\n                .surface .button-primary{\n                    background-color: var(--text-surface-heading);\n                    color: var(--text);\n                    border: none;\n                }\n                button:hover{\n                    opacity: .6;\n                }\n\n                \n                .sidebar-btn{\n                    position: absolute;\n                    left: var(--padding);\n\n                    background-color: var(--primary);\n                    width: 20px;\n                    height: 13px;\n\n                    display: flex;\n                    flex-direction: column;\n                    justify-content: space-between;\n\n                    border: none;\n                    padding: 0;\n                }\n                .sidebar-btn > span {\n                    width: 100%;\n                    height: 2px;\n                    display: block;\n                    background-color: white;\n                }\n\n                header{\n                    position: relative;\n                    display: flex;\n                    justify-content: center;\n                    align-items: center;\n                }\n                main{\n                    height: 100%;\n                    display: flex;\n\n                    position: relative;\n                }\n            </style></head><body><div class=\"overflow\"><header class=\"surface\"><button class=\"sidebar-btn\" onclick=\"toggleSidebar()\"><span></span> <span></span></button><div class=\"logo\"><h1>LOGO</h1></div></header><main>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
